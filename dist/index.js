                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, cli.exec('yarn', ['global', 'add', '@remix-project/remix-tests@0.2.25-alpha.8'])];
                                    case 1:
                                        _a.sent();
                                        return [3 /*break*/, 7];
                                    case 2:
                                        if (!isNPMrepo) return [3 /*break*/, 4];
                                        return [4 /*yield*/, cli.exec('npm', ['install', '@remix-project/remix-tests@0.2.25-alpha.8', '-g'])];
                                    case 3:
                                        _a.sent();
                                        return [3 /*break*/, 7];
