...
exports.escapeRegExp = exports.concatWithSeperator = exports.groupBy = exports.compareByteCode = exports.getinputParameters = exports.extractinputParameters = exports.extractSwarmHash = exports.extractcborMetadata = exports.inputParametersExtraction = exports.cborEncodedValueExtraction = exports.swarmHashExtractionPOC32 = exports.swarmHashExtractionPOC31 = exports.swarmHashExtraction = exports.sha3_256 = exports.buildCallPath = exports.findCall = exports.findClosestIndex = exports.findLowerBoundValue = exports.findLowerBound = exports.formatMemory = exports.toHexPaddedString = exports.hexListFromBNs = exports.hexToIntArray = void 0;
...
function formatMemory(mem) {
    const hexMem = (0, util_1.bufferToHex)(mem).substr(2);
    const ret = [];
...
function sha3_256(value) {
    value = (0, util_1.toBuffer)((0, util_1.addHexPrefix)(value));
    const retInBuffer = remix_lib_1.hash.keccak((0, util_1.setLengthLeft)(value, 32));
    return (0, util_1.bufferToHex)(retInBuffer);
}
