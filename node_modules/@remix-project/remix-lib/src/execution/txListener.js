...
function addExecutionCosts(txResult, tx, execResult) {
    if (txResult) {
        if (execResult) {
            ...
            if (execResult.executionGasUsed)
                tx.executionCost = execResult.executionGasUsed.toString(10);
        }
...
class TxListener {
    constructor(opt, executionContext) {
        ...
        opt.event.udapp.register('callExecuted', (error, from, to, data, lookupOnly, txResult) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.executionContext.isVM()) {
                ...
                returnValue = (0, util_1.toBuffer)(execResult.returnValue);
            }
            else {
                returnValue = (0, util_1.toBuffer)((0, util_1.addHexPrefix)(txResult.result));
            }
            const call = {
                from: from,
                to: to,
    ...
    _startListenOnNetwork() {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const processBlocks = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                var _b, _c;
                if (!this._isListening)
                    return;
                if (processingBlock)
    ...
    _resolveFunction(contract, tx, isCtor) {
        ...
        if (!isCtor) {
            ...
            if (bytecode && bytecode.length) {
                params = this._decodeInputParams((0, util_2.getinputParameters)(inputData), (0, txHelper_1.getConstructorInterface)(abi));
            }
            this._resolvedTransactions[tx.hash] = {
                contractName: contract.name,
                to: null,
    ...
    _tryResolveContract(codeToResolve, compiledContracts, isCreation) {
        ...
        (0, txHelper_1.visitContracts)(compiledContracts, (contract) => {
            ...
            if ((0, util_2.compareByteCode)(codeToResolve, '0x' + bytes)) {
                found = contract;
                return true;
            }
        });
    ...
    _decodeInputParams(data, abi) {
        data = (0, util_1.toBuffer)((0, util_1.addHexPrefix)(data));
        if (!data.length)
