...
export declare function toHexPaddedString(v: bigint | string): string;
...
/**
  ...
  * @return {RegEx}
  */
export declare function inputParametersExtraction(): RegExp;
export declare function extractcborMetadata(value: any): any;
export declare function extractSwarmHash(value: any): any;
export declare function extractinputParameters(value: any): any;
export declare function getinputParameters(value: any): any;
/**
