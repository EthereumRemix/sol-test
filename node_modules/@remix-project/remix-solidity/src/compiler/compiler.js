...
const compiler_input_1 = tslib_1.__importStar(require("./compiler-input"));
const eventManager_1 = tslib_1.__importDefault(require("../lib/eventManager"));
    ...
    loadWorkerHandler() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof (window) !== 'undefined' && Worker) {
                const ESWebWorker = yield Promise.resolve().then(() => tslib_1.__importStar(require('../lib/es-web-worker/es-web-worker-handler')));
    ...
    loadWorker(url) {
        ...
        this.state.worker.addEventListener('message', (msg) => {
            ...
            switch (data.cmd) {
                case 'versionLoaded':
                    if (data.data)
                        this.onCompilerLoaded(data.data, data.license);
                    break;
                case 'compiled':
                    {
                        let result;
