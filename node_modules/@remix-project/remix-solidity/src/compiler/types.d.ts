...
export declare type EVMVersion = 'homestead' | 'tangerineWhistle' | 'spuriousDragon' | 'byzantium' | 'constantinople' | 'petersburg' | 'istanbul' | 'berlin' | 'london' | 'paris' | null;
...
export declare type CompilationSourceCode = {
    sources: SourcesCode;
    target: string;
};
