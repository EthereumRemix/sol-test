import { Source, SourceWithTarget, CompilerState, CompilationResult, visitContractsCallbackInterface, gatherImportsCallbackInterface, EsWebWorkerHandlerInterface } from './types';
export declare class Compiler {
    ...
    loadWorkerHandler(): Promise<void>;
    /**
